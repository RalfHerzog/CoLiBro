...
struct HTTP{
	...
	enum HTTP_POST_METHOD {
		HTTP_POST_METHOD_NONE,
		HTTP_POST_METHOD_PLAIN,
...
extern void http_prepare_header_static( struct HTTP* http, char** query );
extern void __http_send_request_data( struct HTTP* http, const char* header_static );
