...
unsigned char inflateZlibData ( unsigned char** ucomp, int* usize, const unsigned char* comp, const int csize, char mode );
...
unsigned char inflateData( unsigned char** ucomp, int* usize, const unsigned char* comp, const int csize )
{
	int ret;
